...
public class selectionSort4 extends JComponent implements Runnable{
	
	static JFrame frame = new JFrame("Sorting");
	static ArrayList<Double> data= new ArrayList<Double>();
	int ptr1=0,ptr2=0,Times=1000;
	long comparisions=0;
	...
	public static void main(String args[]) {
		...
		frame.getContentPane().add(new selectionSort4());
	...
	public void paint(Graphics g)
	{
		...
		g2D.drawString("Selection Sort", -390, -360);
